package pos.clothify.store.config;
...
public class EncryptionConfig {
    ...
    public  static EncryptionConfig getInstance() {
        return instance==null?instance=new EncryptionConfig():instance;
    }
    public SecretKeySpec getKey() throws NoSuchAlgorithmException, InvalidKeySpecException {
        String password="abey";
